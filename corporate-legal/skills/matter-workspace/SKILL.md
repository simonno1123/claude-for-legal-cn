...
2. Run the intake interview:
   ...
   - **Matter type** (read the plugin's practice profile for typical categories; for corporate-legal: governance audit | capital contribution audit | equity transfer | equity pledge | entity compliance | charter update | 股东会/董事会决议 | other)
